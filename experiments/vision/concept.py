...
Description: Train biLSTM model model (with or without Self Attention) 
    and a png stimulus representation. Concept-Learning experiment.
"""
import uuid
import json
import matplotlib
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data', type=str, default='./data/concept/{}/vision/concat_informative_dataset.tsv',
    ...
    parser.add_argument('--out-dir', type=str, default='/mnt/fs5/schopra/ratchet/lfl/student/concept/models',
                        help='where to save models [default: /mnt/fs5/schopra/ratchet/lfl/student/concept/models]')
    ...
    train_loader, train_vocab = get_data_loader('./data/concept/', 'train', train_vocab_fp, batch_size=args.batch_size)
    val_loader, val_vocab = get_data_loader('./data/concept/', 'val', val_vocab_fp, batch_size=args.batch_size) # TODO: Use val_vocab for validation
    ...
    kwargs['concept_vocab_field'] = train_vocab
    ...
    def compute_loss(batch):
        ...
        logits, alphas = student(texts, images, text_lengths)
    ...
    def train(epoch=-1, backprop=True):
        ...
        for batch_idx, batch in enumerate(train_loader):
            optimizer.zero_grad()
            loss, alphas, logits, labels, batch_size, all_labels, _ = compute_loss(batch)
